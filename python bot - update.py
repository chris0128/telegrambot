...
def main():
    ...
    dispatcher.add_handler(CommandHandler("hello_kevin", hello_kevin_command))
    # To start the bot:
...
def hello_kevin_command(update: Update, context: CallbackContext) -> None:
    """Send a message when the command /hello_kevin is issued."""
